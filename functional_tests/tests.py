...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        """тест: можно начать список для одного пользователя и получить его позже"""
    ...
    def test_multiply_users_can_start_list_at_different_urls(self):
        ...
        # Френсис посещает домашнюю страницу, не замечая никаких признаков списка Эдит
        self.browser.get(self.live_server_url)
    ...
    def test_layout_and_styling(self):
        ...
        # Она начинает новый список и замечает, что поле ввода там тоже аккуратно центрировано
